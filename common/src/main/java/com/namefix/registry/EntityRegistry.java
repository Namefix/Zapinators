...
public class EntityRegistry {
    ...
    public static final RegistrySupplier<EntityType<StarProjectile>> STAR_PROJECTILE = ENTITY_TYPES.register("star_projectile", () ->
            EntityType.Builder.of(StarProjectile::new, MobCategory.MISC)
                    .sized(0.5f, 0.5f)
                    .updateInterval(1)
                    .build(ResourceKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(ZapinatorsMod.MOD_ID, "star_projectile")).toString())
    );
    ...
    public static final RegistrySupplier<EntityType<AngryBee>> ANGRY_BEE = ENTITY_TYPES.register("angry_bee", () ->
            EntityType.Builder.of(AngryBee::new, MobCategory.MISC)
                    .sized(0.2f, 0.2f)
                    .updateInterval(1)
                    .build(ResourceKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(ZapinatorsMod.MOD_ID, "angry_bee")).toString())
            );
    ...
    public static final RegistrySupplier<EntityType<Orb>> ORB = ENTITY_TYPES.register("orb", () ->
            EntityType.Builder.of(Orb::new, MobCategory.MISC)
                    .sized(0.4f, 0.4f)
                    .updateInterval(1)
                    .build(ResourceKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(ZapinatorsMod.MOD_ID, "orb")).toString())
            );
